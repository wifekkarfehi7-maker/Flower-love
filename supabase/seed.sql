...
values
  ('luxury-gold', 'Luxury Gold', 'ذهبي فاخر', 'classic',
   ...
   'active',
   '{"background":"#141210","surface":"#241f1c","primary":"#c9962e","accent":"#f0da96","text":"#f8edc8","textMuted":"#cbc6c0","backgroundStyle":"gradient","cardRadius":"ornate","buttonStyle":"outline-ornate","galleryLayout":"grid","countdownStyle":"ornate","dividerStyle":"ornament","motif":"gem","openAnimation":"envelope"}',
  ...
  ('elegant-white', 'Elegant White', 'أبيض أنيق', 'minimal',
   ...
   'active',
   '{"background":"#faf7f0","surface":"#ffffff","primary":"#a97622","accent":"#e6c165","text":"#241f1c","textMuted":"#847970","backgroundStyle":"solid","cardRadius":"soft","buttonStyle":"pill","galleryLayout":"minimal","countdownStyle":"minimal","dividerStyle":"line","motif":"sun","openAnimation":"curtain"}',
  ...
  ('black-gold', 'Black & Gold', 'أسود وذهبي', 'prestige',
   ...
   'active',
   '{"background":"#000000","surface":"#1c1608","primary":"#dcaa42","accent":"#f0da96","text":"#f8edc8","textMuted":"#b8a878","backgroundStyle":"radial","cardRadius":"ornate","buttonStyle":"outline-ornate","galleryLayout":"masonry","countdownStyle":"ornate","dividerStyle":"ornament","motif":"moon","openAnimation":"envelope"}',
  ...
  ('traditional-arabic', 'Traditional Arabic', 'تراث عربي', 'heritage',
   ...
   'active',
   '{"background":"#082420","surface":"#155048","primary":"#dcaa42","accent":"#f0da96","text":"#f8edc8","textMuted":"#a9c9c0","backgroundStyle":"pattern","cardRadius":"ornate","buttonStyle":"outline-ornate","galleryLayout":"carousel","countdownStyle":"ornate","dividerStyle":"ornament","motif":"wave","openAnimation":"curtain"}',
