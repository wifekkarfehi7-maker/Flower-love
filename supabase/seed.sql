...
values
  ('luxury-gold', 'Luxury Gold', 'ذهبي فاخر', 'classic',
   ...
   'active',
   '{"background":"#141210","surface":"#241f1c","primary":"#c9962e","accent":"#f0da96","text":"#f8edc8"}',
  ...
  ('elegant-white', 'Elegant White', 'أبيض أنيق', 'minimal',
   ...
   'active',
   '{"background":"#faf7f0","surface":"#ffffff","primary":"#a97622","accent":"#e6c165","text":"#241f1c"}',
  ...
  ('floral', 'Floral', 'زهري', 'romantic',
   ...
   'active',
   '{"background":"#fbeef0","surface":"#f6dfe4","primary":"#c85566","accent":"#eda3ac","text":"#5c2230"}',
  ...
  ('romantic', 'Romantic', 'رومانسي', 'romantic',
   ...
   'active',
   '{"background":"#26101a","surface":"#3c1620","primary":"#e17685","accent":"#f6c9cf","text":"#fbe4e6"}',
  ...
  ('modern', 'Modern', 'عصري', 'contemporary',
   ...
   'active',
   '{"background":"#0a0e12","surface":"#1e2833","primary":"#8fa7bd","accent":"#ffffff","text":"#eef2f5"}',
  ...
  ('black-gold', 'Black & Gold', 'أسود وذهبي', 'prestige',
   ...
   'active',
   '{"background":"#000000","surface":"#1c1608","primary":"#dcaa42","accent":"#f0da96","text":"#f8edc8"}',
  ...
  ('traditional-arabic', 'Traditional Arabic', 'تراث عربي', 'heritage',
   ...
   'active',
   '{"background":"#082420","surface":"#155048","primary":"#dcaa42","accent":"#f0da96","text":"#f8edc8"}',
  ...
  ('minimal', 'Minimal', 'بسيط ونقي', 'minimalist',
   ...
   'active',
   '{"background":"#ffffff","surface":"#f7f7f5","primary":"#4f463f","accent":"#c9962e","text":"#241f1c"}',
