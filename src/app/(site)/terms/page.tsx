  ...
  return (
    <section className="bg-background py-20 sm:py-28">
      <Container className="max-w-3xl">
        ...
        <h1 className="mt-3 font-heading text-3xl text-ink-900 sm:text-4xl">شروط الاستخدام</h1>
        ...
        <div className="prose prose-neutral mt-10 max-w-none space-y-8 text-ink-600">
          <div>
            <h2 className="font-heading text-xl text-ink-900">١. طبيعة الخدمة</h2>
          ...
          <div>
            <h2 className="font-heading text-xl text-ink-900">٢. آلية الدفع اليدوي عبر واتساب</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <div>
            <h2 className="font-heading text-xl text-ink-900">٣. مسؤولية المحتوى</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <div>
            <h2 className="font-heading text-xl text-ink-900">٤. الاسترجاع والإلغاء</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <div>
            <h2 className="font-heading text-xl text-ink-900">٥. التواصل</h2>
            <p className="mt-3 leading-relaxed">
