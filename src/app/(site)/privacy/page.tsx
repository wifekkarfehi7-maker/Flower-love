  ...
  return (
    <section className="bg-background py-20 sm:py-28">
      <Container className="max-w-3xl">
        <span className="text-sm font-medium tracking-wide text-gold-600">قانوني</span>
        <h1 className="mt-3 font-heading text-3xl text-ink-900 sm:text-4xl">سياسة الخصوصية</h1>
        ...
        <div className="prose prose-neutral mt-10 max-w-none space-y-8 text-ink-600">
          <div>
            <h2 className="font-heading text-xl text-ink-900">١. البيانات التي نجمعها</h2>
          ...
          <div>
            <h2 className="font-heading text-xl text-ink-900">٢. لماذا نطلب رقم الواتساب</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <div>
            <h2 className="font-heading text-xl text-ink-900">٣. عدم بيع أو مشاركة بياناتكم</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <div>
            <h2 className="font-heading text-xl text-ink-900">٤. أمان البيانات</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <div>
            <h2 className="font-heading text-xl text-ink-900">٥. ملفات تعريف الارتباط والتحليلات</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <div>
            <h2 className="font-heading text-xl text-ink-900">٦. تواصلوا معنا</h2>
            <p className="mt-3 leading-relaxed">
